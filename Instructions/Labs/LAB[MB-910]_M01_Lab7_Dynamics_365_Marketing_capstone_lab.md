...
4. **마케팅 전자 메일 템플릿** 목록에서 **1열 회보**를 선택한 다음 **선택** 단추를 클릭합니다.

5. 세 레코드가 열리면 위쪽의 레코드 머리글에 있는 **상태 설명** 필드 옆의 드롭다운 화살표를 선택합니다. 

6. **이름** 필드에 **홈 시큐리티 - 사용자 이니셜**을 입력합니다. 

7. **제목** 필드에 **가족을 안전하게 보호하세요**!를 입력합니다.

8. 메시지 창에서 **짧은 헤드라인 입력** 텍스트 **위**의 작은 이미지를 찾아서 선택합니다. 

9. 이미지 위에 커서를 올리고 **이미지 갤러리** 단추를 선택합니다. 

10. **Security2 이미지**를 선택하고 **선택** 단추를 클릭하여 전자 메일에 이미지를 삽입합니다. 

11. 이미지의 크기 핸들을 사용하여 이미지를 원하는 크기로 조정합니다. 

12. **짧은 헤드라인 입력** 상자를 클릭하여 선택합니다. 텍스트를 **언제나 철저한 보안 유지**로 변경합니다.

13. 방금 수정한 텍스트 아래의 섹션을 클릭합니다. 
...
16. 이미지 위에 커서를 올리고 **이미지 갤러리** 단추를 선택합니다. 

17. **Security1** 이미지를 선택하고 **선택** 단추를 클릭하여 전자 메일에 이미지를 삽입합니다. 

18. 메시지 창의 단색 부분이 채워지도록 이미지 크기를 조정합니다. 

19. 이미지 바로 아래의 **헤드라인 또는 제목 상자**를 선택하여 텍스트를 **보안 유지에 필요한 모든 제품 구매 가능**으로 바꿉니다. 

20. 방금 수정한 제목 아래의 텍스트 상자를 클릭합니다. 

21. 해당 섹션의 텍스트를 다음 텍스트로 바꿉니다. **수상 경력에 빛나는 ABC 시스템이 고객님의 가정을 철저하게 보호해 드립니다.**

22. 방금 수정한 섹션 아래의 전체 섹션을 클릭하여 선택합니다. **휴지통** 아이콘을 눌러 해당 섹션을 제거합니다. 

23. 메시지의 나머지 섹션에서 위의 프로세스를 반복합니다. 

24. 전자 메일 캠페인을 시작하기 전에 오류를 확인합니다. **명령 모음**에서 **오류 확인** 단추를 선택합니다. 

25. 오류가 없음을 확인한 후 **명령 모음**에서 **가동** 단추를 선택합니다. 

26. 명령 모음의 **저장** 단추 옆에 있는 드롭다운 화살표를 클릭하고 **저장 후 닫기**를 선택합니다. 

마케팅 애플리케이션의 다른 영역에서 활용할 수 있는 마케팅 전자 메일을 작성했습니다. 

## 연습 2: Dynamics 365 Marketing에서 세그먼트 만들기
...
7. **구성원** 탭을 선택합니다. **Rick Jones - 사용자 이니셜**이 포함되어 있어야 합니다. 
...
5. **포함** 드롭다운 아래의 세그먼트 영역 안을 클릭합니다. 
...
10. 화면 왼쪽의 **If/Then**에 있는 조건 아래에서 **원본 선택** 필드 안을 클릭합니다. 

11. **홈 시큐리티 - 사용자 이니셜** 세그먼트를 선택합니다. 

12. **조건 선택** 필드 안을 클릭합니다. **링크를 클릭함**을 선택합니다.
