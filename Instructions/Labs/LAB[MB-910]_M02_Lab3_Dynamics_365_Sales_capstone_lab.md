...
10. 레코드 위쪽에 **잠재 고객 - 영업 기회** 비즈니스 프로세스 흐름이 표시됩니다. 우량으로 선별 스테이지를 클릭하여 선택합니다. 다음과 같이 스테이지를 완성합니다.
...
2. **내 시작된 영업 기회** 보기 옆의 아래쪽 화살표를 선택하고 표시되는 메뉴에서 **시작된 영업 기회**를 선택합니다.
...
27. **다음 스테이지** 단추를 클릭하여 제안 스테이지로 이동합니다.
